 ...
 <th><select class="form-control " data-live-search="true" name="product" readonly>
                       ...
                       <tr>
                        ...
                        <tr>
                         ...
                         <tr>
                            <th> <label class="form-label">GUARANTEE PERIOD</label></th>
                           <th><select class="form-control"  name="gp_status">
                            ...
                            <option value="2">1 YEAR</option>
                             <option value="3">2 YEAR</option>
                               ...
                               <th> <label class="form-label">WARRANTY PERIOD</label></th>
                           <th><select class="form-control"  name="wp_status">
                                    <option>SELECT</option>
                                     <option value="0">NIL</option>
                                     <option value="1">6 MONTHS</option>
                            <option value="2">1 YEAR</option>
    ...
    margin-top: 10px;" name="send" value="SEND FOR VALIDATION" class="btn btn-info"></th>
     ...
     $sql    = " UPDATE ad_table SET gp_status='$gp_status',wp_status='$wp_status',saleprice='$your',type='$type',negstatus='$negs',adtype='0',duedate='$odd',image='$image' WHERE ADid='$proid' ";
       $res    =   mysqli_query($con, $sql) or die(mysqli_query($con));                                               
     ...
     $sql    = " UPDATE ad_table SET gp_status='$gp_status',wp_status='$wp_status',saleprice='$your',type='$type',negstatus='$negs',adtype='1',duedate='$odd',image='$image',percentage='$persentage' WHERE ADid='$proid' ";
       $res    =   mysqli_query($con, $sql) or die(mysqli_query($con));                                               
        echo "<script>window.location='showad_1.php?id=$p'</script>";   
