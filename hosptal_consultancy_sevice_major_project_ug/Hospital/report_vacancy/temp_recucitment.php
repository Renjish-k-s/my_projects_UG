...
.add_more{ float: right; font-size: 14px;  background: #f00;  padding: 10px 20px;  color: #fff; border-radius: 4px;}
    ...
    <body >
      ...
      <a href="job_request.php" >   <div class="newo" ><lable class="lablex">JOB REQUESTS</lable></div>    </a>
        ...
        <div class="mainbarx">
      <a href="recucitment.php" >   <div class="newox" ><lable class="lablex" >PERMANENT RECRUITMENT</lable></div>    </a>
      <a href="temp_recucitment.php" >   <div class="newox" style="background-color:yellowgreen"><lable class="lablex" style="color:black;">TEMPORARY RECRUITMENT</lable></div>    </a>
     ...
     <?php }?>
                            ...
                            <tfoot>
                                <tr>
                                    <th><label>LAST DAY FOR APPLY</label></th>
                             <th><input type="date" class="form-control" name="due_date" required></th>
                               <th><label>DESCRIPTION ABOUT RECRUITMENT</label></th>
...
<th style="text-align: right;"><label>TIME SPAN</label></th>
                  <th><select name="time_span" class="form-control">
...
<tr>
 <th style="    text-align: center;" colspan="7"><input type="submit" name="send" value="SUBMIT" class="btn btn-info" style="width: 18%;height: 54px;margin-left: 84px;"></th>
                        </tr>
                    </tfoot>
            ...
            for($i="0"; $i<=$count; $i++){
              $pname1     =   $pname[$i];
               ...
               $no_vacancy1        =   $no_vacancy[$i];
                if($pname1!=""){
 $sql = "INSERT INTO recriutment_create_table (creator_id,recruitment_id,category,post_name,educational_qualification,age_from,age_to,pay_from,pay_to,description,apply_end_date,no_vacancy,time_span) VALUES ('$creatorid','$rec_id','$categoty','$pname1','$equal1','$age_from1','$age_to1','$pay_from1','$pay_to1','$description','$due_date','$no_vacancy1','$time_span')";
