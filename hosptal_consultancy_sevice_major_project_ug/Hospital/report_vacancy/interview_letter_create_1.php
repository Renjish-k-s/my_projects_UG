...
.subject1{    float: left;
    ...
    <body>
      ...
      <form action="" method="post" enctype="multipart/form-data">
        <div class="container">
            <div><h2 class="h1x" style="color: black">INTERVIEW CALL E-LETTER</h2></div>
       
         <input type="hidden" class="form-control" name="title" value="INTERVIEW CALL" readonly="on" >
...
if(isset($_POST['sendforvalidation']))
{
 $creator_id= $_SESSION['custid'];
    ...
    $sql    = " insert into e_letter_box (from_1,to_1,recr_id,type,message,date,time,rdate,rtime,raddress) VALUES ('$creator_id','$toaddress','$recid','$title','$content','$date','$time','$rdate','$rtime','$raddress')";
       $res    =   mysqli_query($con, $sql) or die(mysqli_query($con)); 
