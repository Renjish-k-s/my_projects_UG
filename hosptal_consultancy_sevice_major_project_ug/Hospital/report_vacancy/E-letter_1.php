...
if(isset($_POST['sendforvalidation']))
{
  ...
  if($tid==1){
        echo "<script>window.location='interview_letter_create_1.php?cid=$cid&rid=$rid'</script>";  
  }
   if($tid==2){
        echo "<script>window.location='exam_call_letter_create_1.php?cid=$cid&rid=$rid'</script>";  
  }
   if($tid==3){
        echo "<script>window.location='appointment_letter_create_1.php?cid=$cid&rid=$rid'</script>";  
  }
}
