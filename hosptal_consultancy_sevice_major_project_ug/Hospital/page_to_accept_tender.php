...
.form-control{ width: 70%;
    ...
    border-radius: 14px;}
        ...
        <a href="tenderstatement.php" class="btn btn-info" style="background-color: black;margin-left: 25px;">BACK</a>
...
<input type="hidden" name="bid" class="form-control"  value="<?php echo "ORDER-".$count; ?>"  readonly>
                          <tr>
