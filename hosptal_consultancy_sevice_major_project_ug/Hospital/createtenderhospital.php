...
select.bs-select-hidden, select.selectpicker {
    ...
    <body >
        ...
        <div class="mainbar">
            ...
            <div class="newo" style="background-color:white"><a href="createtenderhospital.php" class="buttn" style="color:black"> CREATE TENDER</a></div>
            <div class="newo"><a href="yourtenders.php" class="buttn">YOUR TENDERS</a></div>
