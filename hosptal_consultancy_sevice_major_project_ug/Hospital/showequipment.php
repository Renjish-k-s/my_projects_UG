...
.pr_box{    background: #fff;  padding: 30px;  border-radius: 10px; float: left;     min-height: 585px;    margin-right: 1%;
    ...
    <body >
        <div class="div2">
            ...
            <p class="p1">"WE ARE AT YOUR SERVICE"</p>
                        <a href="norequipments.php" class="btn btn-info" style="background-color: black;margin-left: 25px;">BACK</a>
         ...
         ?>
                ...
                <div class="pr_box">
                    ...
                    <div class="pr_details">
                        ...
                        <?php } ?>
                        <?php if($row['gp_status']!='0') {  ?>
                        <div class="pr_otherx">
                            <div class="pr_price" style="color: red;"><?php if($row['gp_status']=='1'){
                                
     echo '6 MONTHS GUARANTEE';
                                
                                 }
                                 if($row['gp_status']=='2'){
                                
     echo '1 YEAR GUARANTEE';
                                
                                 }
                                  if($row['gp_status']=='3'){
                                
     echo '2 YEAR GUARANTEE';
                                
                                 }?></div>
                           
                        </div>
                        <?php } ?>
                         <?php if($row['wp_status']!='0') {  ?>
                        <div class="pr_otherx">
                            <div class="pr_price" style="color: red;"><?php if($row['wp_status']=='1'){
                                
     echo '6 MONTHS WARRANTY';
