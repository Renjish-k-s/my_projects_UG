<?php include_once("../include/config.php"); ?>
 <?php
                ...
                $sql    =   "SELECT product.*,ad_table.*,product.name as f,product.sname as u FROM product LEFT JOIN ad_table ON product.pid=ad_table.name WHERE type='pharmacy' AND adtype='2' AND ad_table.status='1'";
