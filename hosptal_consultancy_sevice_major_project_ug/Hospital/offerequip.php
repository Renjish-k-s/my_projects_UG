...
.pr_box:hover{background-color: #ccc;}
    ...
    <body >
       ...
       <div class="mainbar">
            ...
            <a href="medoffer.php" class="buttn"><div class="newo" ><h4  ><i>MEDICINE OFFERS</i></h4></div></a>
        <a href="norequipments.php" class="buttn" > <div class="newo" ><h4 ><i>PURCHASE EQUIPMENTS</i></h4></div></a>
        <a href="offerequip.php" class="buttn" > <div class="newo" style="background-color: white;"><h4 style="color:black;"><i>EQUIPMENT OFFERS</i></h4></div></a>
        ...
        <div class="container">
            ...
            <div class="products" id="search_result">
                <?php include_once("offerequip_ajax.php"); ?>
            </div>
      ...
      <script>
        $( function() {
          var availableTags = [
              <?php
                  $sql    =   "SELECT product.*,ad_table.*,product.name as f,product.usefor as u FROM product LEFT JOIN ad_table ON product.pid=ad_table.name WHERE type='lab' AND adtype='2'  AND ad_table.status='1'";
