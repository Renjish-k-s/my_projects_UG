     ...
     <form>
          <table id="tbl-patient" class="table table-responsive table bordered" border="1px"  cellpadding="0" width="100" style="background-color:white;">
            ...
            $creatorid     = $_SESSION['custid'];
                                            $sql    =   "SELECT * FROM tenderdetails WHERE tender_creator_id='$creatorid' AND status='0' GROUP BY tender_id";
                                         ...
                                         <tr>
                                          ...
                                          <td><a href="view_tender_submissions.php?id=<?php echo $row['tender_id'] ?>"  class="btn btn-info" style="width: 48%;padding: 28px;background-color: blue">VIEW TENDER SUBMISSIONS</a></td>
