...
.newo1:hover{background-color: greenyellow;}
    ...
    <body >
       ...
       <div class="mainbar">
           ...
           <a href="createtenderhospital.php" > <div class="newo"  style="color:white;" > CREATE TENDER</div></a>
           <a href="yourtenders.php" style="color:black"><div class="newo" style="background-color:white">YOUR TENDERS</div></a>
          ...
          <table id="tbl-patient" class="table table-responsive table bordered" border="1px"  cellpadding="0" width="100" style="background-color:white;">
                                  ...
                                  <td><?php echo $i; ?>  </td>
                                         ...
                                         ?>
                                          ...
                                          <td><a href="page_to_accept_tender.php?id=<?php echo base64_encode($row['teid']);?>&cid=<?php echo base64_encode($row['custid']);?>"  class="btn btn-info" style="width: 48%;padding: 28px;">ACCEPT TENDER</a></td>
                                          <td><a href="reject.php?id=<?php echo $row['teid'];?>&cid=<?php echo $row['custid'];?>"  class="btn btn-info" style="width: 48%;padding: 28px;background-color: red;">REJECT</a></td>
