      ...
      <div class="bar">
          ...
          <div class="mainbar" style="background-color: blueviolet;">
            ...
            <a href="orderdetails.php" class="buttn"  ><div class="newo1" > <h4><i>LATEST ORDERS</i></h4></div></a>
                        <a href="abouttodeliver.php" class="buttn"  ><div class="newo1" style="background-color: blue;"> <h4><i>ABOUT TO DELIVER</i></h4></div></a>
                        <a href="deliveredorder.php" class="buttn"  ><div class="newo1" > <h4 ><i>DELIVERED ORDERS</i></h4></div></a>
            ...
            <table id="tbl-patient" class="table table-responsive table bordered" border="1px"  cellpadding="0" width="100" style="background-color:white;">
                                     <thead>
                                         ...
                                         $custid=$_SESSION['custid'];
                                            $sql    =   "SELECT * FROM medicine_order WHERE custid='$custid' AND status='1' ORDER BY delivery_date ";
                                         ...
                                         ?>
                                          ...
                                          <td><?php echo $row1['name']; ?>  </td>
                                           ...
                                           <td><?php if($row['status']=='1'){ echo $row['delivery_date'];}?>
                                                     
                                         </td>
                                             
                                             
     <td>  <a href="delivery_sheet.php?id=<?php echo $row['id'];?>"  class="btn btn-info" style="width: 95%;padding: 13px;"  >ORDER DETAILS</a></td>
     <td>  <a href="reorder.php?id=<?php echo $row['Bid'];?>"  class="btn btn-info" style="width: 95%;padding: 13px;background-color: blue;"  >RE-ORDER</a></td>
     <td>  <a href="cancelorder.php?id=<?php echo base64_encode($row['Bid']);?>"  class="btn btn-info" style="width: 95%;padding: 13px;background-color: red;"  >CANCEL ORDER</a></td>
