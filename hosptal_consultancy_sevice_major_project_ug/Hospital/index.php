...
<html>
    <head>
      ...
      <style>
 body{
               background-image: url(../home/consultancy-1.jpg);
...
.name21:hover{background-color:red;}
        ...
        <div class="div2">
            ...
            <div class="main">
              ...
              <div class="sub">
                  ...
                  <a href="normedicine.php" >
              <div class="sub">
                       <lable class="lable1">PURCHASE PRODUCTS</lable>   
                </div></a>
                 <a href="blood_help.php" >
              <div class="sub">
                       <lable class="lable1">BLOOD FINDER</lable>   
                </div></a>
  ...
  <a href="tender_control/createtenderhospital.php" >
              <div class="sub">
                       <lable class="lable1">TENDER CONTROL</lable>   
                </div></a>
