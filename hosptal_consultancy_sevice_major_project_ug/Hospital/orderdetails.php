    ...
    <body >
       ...
       <div class="bar">
        ...
        <div class="mainbar" style="background-color: blueviolet;">
            ...
            <a href="orderdetails.php" class="buttn"  ><div class="newo1" style="background-color: blue;" > <h4><i>LATEST ORDERS</i></h4></div></a>
            ...
            <table id="tbl-patient" class="table table-responsive table bordered" border="1px"  cellpadding="0" width="100" style="background-color:white;">
                                     <thead>
                                         ...
                                         $custid=$_SESSION['custid'];
                                            $sql    =   "SELECT * FROM medicine_order WHERE custid='$custid' AND status='0' ORDER BY delivery_date desc";
                                         ...
                                         ?>
                                          ...
                                          <td><?php echo $row1['name']; ?>  </td>
                                           ...
                                           <td><?php if($row['status']=='0'){ echo 'DELIVERY DATE WILL BE SEND SOON';}?>
