    ...
    <body >
        ...
        <div class="mainbar">
         ...
         <div class="mainbar " style="background-color:green">
            ...
            <div class="newo1" ><a href="tender_requests.php" class="buttn" > TENDER REQUESTS</a></div>
            <div class="newo1" style="background-color:blue"><a href="accepted_tenders.php" class="buttn"  style="color:white">ACCEPTED TENDERS</a></div>
        </div>
