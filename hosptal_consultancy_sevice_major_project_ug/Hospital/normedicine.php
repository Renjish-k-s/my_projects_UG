...
.pr_box{    background: #fff; width: 48%; padding: 30px;border-radius: 10px; float: left;min-height: 278px;margin-right: 1%;margin-bottom: 1%;}
...
label {
    ...
    <body >
     ...
     <div class="bar">
               <a href="normedicine.php" > <div class="bar1 bar2">
        ...
        <div class="container">
            ...
            <div class="products" id="search_result">
                ...
                <?php include_once("normedicine_ajax.php"); ?>
          ...
          var availableTags = [
              <?php
                $sql    =   "SELECT product.*,ad_table.*,product.name as f,product.usefor as u 
                              ...
                              WHERE type='pharmacy' GROUP BY f";
