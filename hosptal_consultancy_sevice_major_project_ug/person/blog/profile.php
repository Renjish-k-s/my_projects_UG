...
.bar2{background-color: #ccc;}
     ...
     $sql    =   "SELECT  * FROM blog_table WHERE creator_id='$id' AND type='0' AND status='1'";
     $res    =   mysqli_query($con, $sql) or die(mysqli_query($con));
        $get= mysqli_fetch_array($res);
        
    $custid= $get['creator_id'];
      $find    =   "SELECT  * FROM common_login WHERE pid='$custid'";
     $findx    =   mysqli_query($con,$find) or die(mysqli_query($con));
   $result =mysqli_fetch_array($findx);
        ...
        <div class="full" style="background-image:url('../../documents/natue.jpg');">
            ...
            <div class="profilepic">
             ...
             <div class="profilepic">
                 <div class="pic">
                     <img src="../../documents/<?php echo $result['company_picture'] ?>" class="picz">
                 </div>
                 <div class="name"><h3 style="color:white;    font-size: 35px;background-color: black;"><?php echo $result['name'] ?></h3></div>
        </div>
            </div>
       <div class="bar">
