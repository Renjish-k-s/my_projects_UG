...
label{    margin-left: 14px;font-size: larger;}
    ...
    <body >
      ...
      <a href="job_request.php" >   <div class="newo" ><lable class="lablex">APPLICATION STATUS</lable></div>    </a>
        </div>
...
<table id="tbl-patient" class="table table-responsive table bordered tab_a" border="1px"  cellpadding="0" width="100" style="background-color:white;">
                                     <thead>
                                         ...
                                         <?php
                                            $sql    =   "SELECT * FROM recriutment_create_table WHERE status='0' GROUP BY recruitment_id";
