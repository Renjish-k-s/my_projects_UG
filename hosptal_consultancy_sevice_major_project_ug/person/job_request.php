      ...
      <a href="job_request.php" >   <div class="newo" style="background-color:white" ><lable class="lablex" style="color:black;">APPLICATION STATUS</lable></div>    </a>
          ...
          <table id="tbl-patient" class="table table-responsive table bordered tab_a" border="1px"  cellpadding="0" width="100" style="background-color:white;">
                                     <thead>
                                         ...
                                         <?php
                                         $id=$_SESSION['pid'];
                                            $sql    =   "SELECT * FROM application_box WHERE applicant_id='$id'";
                                       ...
                                       <td style="padding: 26px;"><label><?php if($row1['status']=='0'){ echo "ON PROCESS";} ?></label></td> 
                                           ...
                                           <td style="text-align:center;padding: 26px;"><a href="show_letter.php?id=<?php echo $job_id ;?>" class="btn btn-info" style="width: 75%;height: 100% ;padding: 19px;font-size: revert;background-color: blue;">E-LETTER</a></td>
                                             </tr>
