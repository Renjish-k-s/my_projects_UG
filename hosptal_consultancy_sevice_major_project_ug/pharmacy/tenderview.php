...
label{    margin-top: 10px;}
    ...
    <body >
        ...
        <div class="mainbar">
            ...
            <a href="tenderview.php" > <div class="newo" style="background-color:white;"><label style="color:black;">LATEST TENDERS</label></div></a>
        ...
        <form>
          <table id="tbl-patient" class="table table-responsive table bordered" border="1px"  cellpadding="0" width="100" style="background-color:white;">
                                     <thead>
                                         ...
                                         <?php
                                            $sql    =   "SELECT * FROM tenderdetails WHERE product_type='1' AND status='0' GROUP BY tender_id";
                                         ...
                                         ?>
                                          ...
                                          <td><a href="tenderstatement.php?id=<?php echo base64_encode($row['tender_id']); ?>"  class="btn btn-info" style="width: 110%;padding: 28px;">VIEW TENDER DETAILS</a></td>
                                         </tr>
                                            <?php } ?>
                                     </thead>
                                       </table>
