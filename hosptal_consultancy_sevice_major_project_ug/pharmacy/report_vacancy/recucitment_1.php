...
select.bs-select-hidden, select.selectpicker {
    ...
    <body >
      ...
      <a href="job_request.php" >   <div class="newo" ><lable class="lablex">JOB REQUESTS</lable></div>    </a>
        ...
        <div class="mainbarx">
      <a href="recucitment.php" >   <div class="newox" ><lable class="lablex" style="color:black;">PERMANENT RECRUITMENT</lable></div>    </a>
      <a href="recucitment_1.php" >   <div class="newox" style="background-color:yellowgreen"><lable class="lablex" >TEMPORARY RECRUITMENT</lable></div>    </a>
...
give you all the opportunity to be the member of our team</textarea></th>
                  ...
                  <th><select name="time_span" class="form-control">
                     ...
                     <option value="CAN'T DISCLOSE">CAN'T DISCLOSE</option>
                                    ...
                                    <tr>
 <th style="    text-align: center;" colspan="7"><input type="submit" name="send" value="SUBMIT" class="btn btn-info" style="width: 25%;height: 54px;margin-left: 84px;"></th>
                        </tr>
                    </tfoot>
