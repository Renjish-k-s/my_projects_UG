...
if(isset($_POST['sendforvalidation']))
{
 $creator_id= $_SESSION['custid'];
    ...
    $sql    = " insert into e_letter_box (from_1,to_1,recr_id,type,message,date,time,rdate,rtime,raddress,typeid) VALUES ('$creator_id','$to','$recid','$title','$content','$date','$time','$rdate','$rtime','$raddress','3')";
       $res    =   mysqli_query($con, $sql) or die(mysqli_query($con));                                               
