...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.7.0/css/font-awesome.min.css">
    ...
    <body>
         ...
         <a href="tenderview.php" style="background-color: black;margin-left: 25px;" class="btn btn-info" >BACK</a>
          </ul>
             </div>
        <?php
    ...
    <div class="col-sm-12">
        ...
        ?>
                                   ...
                                   <tr>
                                       <td><a href="submittender.php" class="btn btn-info" >QUOTE YOUR AMOUNT HERE</a></td>
                                   </tr>
