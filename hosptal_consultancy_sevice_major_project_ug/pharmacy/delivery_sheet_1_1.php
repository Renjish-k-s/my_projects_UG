                     ...
                     <tr>
                       ...
                       <tr>
                           <td style="text-align:left">
                               ...
                               <th><input type="date" class="form-control" name="ddate" required="on" ></th>
                               </tr>
                                 <tr> 
       ...
       <?php
           $oid1=$_GET['id'];
            ...
            $rowx =mysqli_fetch_array($resx)
                                   ...
                                   <tr>                       
                                       <td colspan="5" style="text-align: center;"><input type="submit" style="    padding: 18px;" name="send" value="SEND DELIVERY DATE" class="btn btn-info"></td>
...
$sql4    = " UPDATE medicine_order SET delivery_date='$ddate',status='1' WHERE Bid='$orderid' ; ";
