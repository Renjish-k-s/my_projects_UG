   ...
   $row =mysqli_fetch_array($res);
        ...
        <div class="full" style="background-image:url('../../documents/<?php echo $row['base_picture'] ?>');">
            ...
            <div class="profilepic">
                <a href="../index.php" class="btn btn-info" style="margin-top: 15px;
    margin-left: 10px;
    padding: 17px;
...
<div class="row">
  <div class="leftcolumn">
     ...
     $sql    =   "SELECT  * FROM blog_table WHERE type='0' AND status='1'";
     $res    =   mysqli_query($con, $sql) or die(mysqli_query($con));
     ...
     <div class="card">
              ...
              <div class="mainbox">
                  <a href="../../documents/<?php echo $row['company_picture'] ?>"><div class="imagebox"> <img  src="../../documents/<?php echo $row['company_picture'] ?>" class="imagebox" > </div> </a>
                      <div class="namebox">
                          <a href="profile.php?id=<?php echo base64_encode($row['creator_id']); ?>" ><h2 style="color:black;"><?php echo $row['creator_name']; ?></h2></a>
                          </div>
