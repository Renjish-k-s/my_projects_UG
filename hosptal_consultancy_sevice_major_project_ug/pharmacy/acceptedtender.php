    ...
    <body >
        ...
        <form>
           <table id="tbl-patient" class="table table-responsive table bordered" border="1px"  cellpadding="0" width="100" style="background-color:white;">
                         ...
                         $sql    =   "SELECT tenderdetails.*,tenderquotes.* FROM tenderdetails LEFT JOIN tenderquotes ON tenderdetails.id= tenderquotes.pid WHERE custid='$custid' AND tenderquotes.status='10'  GROUP BY teid";
