...
.sybmain:hover{background-color: #ccc;}
      ...
      <body >
        ...
        <div class="mainbar">
           ...
           <a href="company_index_1.php"> <div class="newo"><label>PHARMACEUTICAL</label></div></a>
           <a href="company_index_2.php"> <div class="newo" style="background-color:white"><label style="color:black;">EQUIPMENT MANUFACTURERS</label></div></a>
           </div>
          
          <div class="main">
               <?php
               $sql    =   "SELECT * FROM  company_user WHERE ctype='LABORATORY'";
               $res    =   mysqli_query($con, $sql) or die(mysqli_query($con));
               while($row =mysqli_fetch_array($res)){
                                         ?>
              <a href="stock/pharmacy_stocktable_1.php?id=<?php echo $row['custid']; ?>"><div class="sybmain">
