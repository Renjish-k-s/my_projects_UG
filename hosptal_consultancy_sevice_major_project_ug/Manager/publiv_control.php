    ...
    <body >
       ...
       <div class="mainbar" style="background-color:blue;">
            ...
            <a href="usercontrol.php"  ><div class="newo" ><h4>COMPANY USER</h4></div></a>
             ...
             <div class="mainbar">
           <a href="publiv_control.php" ><div class="newo1" style="background-color:skyblue;color: black;"><h4 class="head1">USER REQUESTS</h4></div></a>
        ...
        <form>
          <table id="tbl-patient" class="table table-responsive table bordered" border="1px"  cellpadding="0" width="100" style="background-color:white;">
                                     <thead>
                                         ...
                                         <?php
                                            $sql    =   "SELECT * FROM  common_login WHERE status='1' ";
                                     ...
                                     <td><a href="update_recrutdoctor.php?id=<?php echo $row['pid']; ?>" class="btn btn-info">VIEW DETAILS</a></td>
                                         </tr>
                                            <?php } ?>
                                     </thead>
                                       </table>
