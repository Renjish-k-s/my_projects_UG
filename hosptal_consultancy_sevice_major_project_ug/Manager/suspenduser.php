        ...
        <div class="mainbar" style="background-color:blue;">
          ...
          <div class="mainbar">
           <a href="usercontrol.php" ><div class="newo1" ><h4 class="head1">USER REQUEST</h4></div></a>
            <a href="activeuser.php" ><div class="newo1" ><h4 class="head1">ACTIVE USERS</h4></div></a>
            <a href="suspenduser.php" ><div class="newo1" style="background-color:skyblue;color: black;"><h4 class="head1">SUSPENDED USERS</h4></div></a>
          ...
          <table id="tbl-patient" class="table table-responsive table bordered" border="1px"  cellpadding="0" width="100" style="background-color:white;">
                                     <thead>
                                         ...
                                         <?php
                                            $sql    =   "SELECT * FROM  company_user WHERE active_status='2' ";
                      ...
                      <td><a href="add_user.php?id=<?php echo $row['custid']; ?>" class="btn btn-info" style="background-color:red;">ADD USER</a></td>
