    ...
    <body >
       ...
       <div class="mainbar" style="background-color:blue;">
           ...
           <a href="publiv_control.php" ><div class="newo1" ><h4 class="head1">CREATE USER</h4></div></a>
            <a href="publiv_control_active.php" ><div class="newo1"  ><h4 class="head1">ACTIVE USERS</h4></div></a>
            <a href="publiv_control_suspended.php" ><div class="newo1" style="background-color:skyblue;color: black;"><h4 class="head1">SUSPENDED USERS</h4></div></a>
        ...
        <form>
         <table id="tbl-patient" class="table table-responsive table bordered" border="1px"  cellpadding="0" width="100" style="background-color:white;">
                                     <thead>
                                         ...
                                         <?php
                                            $sql    =   "SELECT * FROM  common_login WHERE status='9' ";
...
<?php if($row['utype']=='DOCTOR'){ ?>
                                     ...
                                     <td><a href="update_recrutnurse_1.php?id=<?php echo $row['pid']; ?>" class="btn btn-info">VIEW DETAILS</a></td>
                                            <?php  } ?>
                                     <td><a href="add_user_1.php?id=<?php echo $row['pid']; ?>" class="btn btn-info" style="background-color: red;">ADD USER</a></td>
