 ...
 $creator_id= $_SESSION['custid'];
        ...
        $duration=$_POST['duration'];
         ...
         $syllabus   =   $_FILES['syllabus']['name'];	
          ...
          if($toaddress!=""){
    $sql    = " insert into e_letter_box (from_1,to_1,recr_id,type,message,date,time,rdate,rtime,raddress,duration,syllabus,typeid) VALUES ('$creator_id','$toaddress','$recid','$title','$content','$date','$time','$rdate','$rtime','$raddress','$duration','$syllabus','1')";
       $res    =   mysqli_query($con, $sql) or die(mysqli_query($con));     
          }
                             }
