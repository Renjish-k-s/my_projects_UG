    ...
    <body >
        ...
        <div class="mainbar">
            ...
            <a href="blog_request.php"  ><div class="newo"><label>BLOG REQUESTS</label></div></a>
                            <a href="blog_request_1.php"  ><div class="newo "><label>ACTIVE BLOGS</label></div></a>
            <a href="blog_compliants.php"  ><div class="newo neo"><label>BLOG COMPLAINTS</label></div></a>
          ...
          <table id="tbl-patient" class="table table-responsive table bordered" border="1px"  cellpadding="0" width="100" style="background-color:white;">
                                     <thead>
                                         <tr>
                                           ...
                                           <?php
                                            $sql1    =   "SELECT * FROM  report_blog WHERE status='0' ";
                                            $res2    =   mysqli_query($con,$sql1) or die(mysqli_query($con));
                                             while($row1 =mysqli_fetch_array($res2)){

                                            ?>
                                         <?php
                                         $id1=$row1['blogid'];
                                            $sql    =   "SELECT * FROM  blog_table WHERE status='1' AND id='$id1' ";
