...
.neo{background-color: white;color: black}
    ...
    <body >
        ...
        <div class="mainbar">
            ...
            <a href="blog_request.php"  ><div class="newo neo"><label>BLOG REQUESTS</label></div></a>
        ...
        <form>
          <table id="tbl-patient" class="table table-responsive table bordered" border="1px"  cellpadding="0" width="100" style="background-color:white;">
                                     <thead>
                                         ...
                                         <?php
                                            $sql    =   "SELECT * FROM  blog_table WHERE status='0'  ";
           ...
           <?php if($row['type']=='0'){ ?>
              ...
              <td><?php echo 'RECRUITMENT'; ?>  </td>
               ...
               <td> <a href="create_blog.php?id=<?php echo $row['id']; ?>" class="btn btn-info">VIEW DETAILS</a></td>
