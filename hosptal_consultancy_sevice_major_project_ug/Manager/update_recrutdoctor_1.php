...
.x_1{}  
    ...
    <body >
        <div class="div2">
            ...
            <a href="publiv_control_active.php" class="btn btn-info" style="background-color: black;margin-left: 25px;">BACK</a>
        </div>
        <div class="container">
         ...
         <tr>
                 ...
                 <select class="form-control" name="spin" id=""    required>
                                 <option value="">SPECIALIZED IN</option>
                                    <?php
                 $sql    =   "SELECT * FROM qualification WHERE qualification='1'";
                 $res    =   mysqli_query($con, $sql) or die(mysqli_query($con));
