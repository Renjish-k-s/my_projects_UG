    ...
    <body >
      ...
      <div class="mainbar">
           <a href="staff_control.php" ><div class="newo1" ><h4 class="head1">CREATE USER</h4></div></a>
            <a href="activestaff.php" ><div class="newo1"  style="background-color:skyblue;color: black;"><h4 class="head1">ACTIVE USERS</h4></div></a>
        ...
        <table id="tbl-patient" class="table table-responsive table bordered" border="1px"  cellpadding="0" width="100" style="background-color:white;">
                                     ...
                                     <td><a href="suspendstaff.php?id=<?php echo $row['id']; ?>" class="btn btn-info" style="background-color:red;">SUSPEND</a></td>
