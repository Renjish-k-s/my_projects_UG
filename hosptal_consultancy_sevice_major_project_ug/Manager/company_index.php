...
.sybmain:hover{background-color: #ccc;}
      ...
      <body >
        ...
        <div class="mainbar">
            ...
            <a href="company_index.php"> <div class="newo" style="background-color:white"><label style="color:black;">HOSPITALS</label></div></a>
          ...
          <div class="main">
               <?php
               $sql    =   "SELECT * FROM  company_user WHERE ctype='HOSPITAL'";
               $res    =   mysqli_query($con, $sql) or die(mysqli_query($con));
               while($row =mysqli_fetch_array($res)){
                                         ?>
              <a href="stock/index.php?id=<?php echo $row['custid']; ?>"><div class="sybmain">
