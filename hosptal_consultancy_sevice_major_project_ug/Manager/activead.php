    ...
    <body >
        ...
        <div class="mainbar">
            ...
            <a href="adcontrol.php"  ><div class="newo"><label>AD REQUESTS</label></div></a>
                            <a href="activead.php"  ><div class="newo neo"><label>AD ACTIVE</label></div></a>
        ...
        <form>
          <table id="tbl-patient" class="table table-responsive table bordered" border="1px"  cellpadding="0" width="100" style="background-color:white;">
                                     <thead>
                                         ...
                                         <?php
                                            $sql    =   "SELECT * FROM  ad_table WHERE status='1'  ";
           ...
           <td><?php echo $row['quantity']; ?>  </td>
              <td><?php echo $row['price']; ?>  </td>
                                          ...
                                          <td> <a href="suspend.php?id=<?php echo $row['id']; ?>" class="btn btn-info" style="background-color:orangered;">SUSPEND AD</a></td>
