                                 ...
                                 <table id="tbl-patient" class="table table-responsive table bordered" border="3px"  cellpadding="0" width="100">
                                     <thead>
                                         ...
                                         <tr <?php if($row['name']==$s){ ?> style="background: #ccc;" <?php } ?> >
                                             ...
                                             <td>
                                                 <a href="edit_rec.php?id=<?php echo $row['patientno'] ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i>
</a>
                                                 <a href="delete_rec.php?id=<?php echo $row['patientno'] ?>" onclick="return confirm('Are you sure?')"><i class="fa fa-trash-o" aria-hidden="true"></i>
</a>
                                             </td>
                                         </tr>
                                           <?php } ?>
